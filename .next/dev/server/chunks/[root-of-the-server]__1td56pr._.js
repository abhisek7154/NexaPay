...
"[project]/src/app/api/v1/payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$payments$2f$payment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/payments/payment.service.ts [app-route] (ecmascript)");
...
;
;
const paymentService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$payments$2f$payment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaymentService"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$payments$2f$payment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPrismaPaymentStore"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]));
async function POST(request) {
    try {
        const body = await request.json();
        const idempotencyKey = request.headers.get("Idempotency-Key") ?? undefined;
        const result = await paymentService(body, idempotencyKey ? {
            idempotencyKey
        } : undefined);
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$payments$2f$payment$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PaymentError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: error.message
            }, {
...
"[project]/src/generated/prisma/internal/prismaNamespace.ts [app-route] (ecmascript) <export * as Prisma>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/payments/payment.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/generated/prisma/client.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$internal$2f$prismaNamespace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Prisma$3e$__ = __turbopack_context__.i("[project]/src/generated/prisma/internal/prismaNamespace.ts [app-route] (ecmascript) <export * as Prisma>");
;
;
...
function createPrismaPaymentStore(prisma) {
    return {
        ...
        async runInTransaction (callback) {
            return prisma.$transaction(async (tx)=>callback({
                ...
                isolationLevel: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$internal$2f$prismaNamespace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Prisma$3e$__["Prisma"].TransactionIsolationLevel.Serializable
            });
        }
    };
}
function createPaymentService(store) {
    return async function createPayment(rawInput, options) {
        ...
        return store.runInTransaction(async (tx)=>{
            ...
            await tx.updateWalletBalance(sender.id, fromPaise(senderBalanceAfterPaise));
            await tx.updateWalletBalance(receiver.id, fromPaise(receiverBalanceAfterPaise));
            const metadata = {
                kind: "wallet_payment",
                senderId: sender.id,
...
function parsePaymentInput(rawInput) {
...
function asPaymentMethod(value) {
...
function validateCardDetails(card) {
    ...
    const cardHolderName = asNonEmptyString(card.cardHolderName, "Invalid CARD details");
...
function createReferenceId() {
    return `PAY-${Date.now()}-${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID().slice(0, 8)}`;
}
function buildPaymentResponseFromTransaction(transaction) {
...
function parseWalletPaymentMetadata(metadata) {
    if (!metadata) {
        throw new PaymentError(500, "Stored payment metadata is invalid");
    }
    const parsedValue = JSON.parse(metadata);
    if (parsedValue.kind !== "wallet_payment") {
        throw new PaymentError(500, "Stored payment metadata is invalid");
    }
    if (typeof parsedValue.senderId !== "string" || typeof parsedValue.senderName !== "string" || typeof parsedValue.receiverId !== "string" || typeof parsedValue.receiverName !== "string" || typeof parsedValue.receiverUpiId !== "string" || typeof parsedValue.amountPaise !== "number" || typeof parsedValue.senderBalanceAfterPaise !== "number" || parsedValue.paymentMethod !== "UPI" && parsedValue.paymentMethod !== "CARD") {
        throw new PaymentError(500, "Stored payment metadata is invalid");
    }
    return {
        kind: "wallet_payment",
        ...
        ...parsedValue.cardLast4 ? {
            cardLast4: parsedValue.cardLast4
        } : {},
        ...parsedValue.upiId ? {
            upiId: parsedValue.upiId
        } : {}
    };
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1td56pr._.js.map