...
"[project]/src/app/api/v1/users/[userId]/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transaction.findMany({
            orderBy: {
                createdAt: "desc"
            },
            take: 25
        ...
        const userTransactions = transactions.map((transaction)=>{
            ...
            const counterparty = senderId === userId ? metadata?.receiverName ?? "Receiver" : metadata?.senderName ?? "Sender";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1tbmbvn._.js.map